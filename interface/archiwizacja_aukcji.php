...
while($row=pg_fetch_assoc($result)){
        ...
        echo "<td>";
        echo "<a href='archiwizacja_samochodu.php?id=". $row['samochod_id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-remove'></span></a>";
        echo "</td>";
        echo "</tr>";
}
