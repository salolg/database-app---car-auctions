...
while($row=pg_fetch_assoc($result)){
        ...
        echo "<td>";
        echo "<a href='udostępnianie_samochodow.php?id=". $row['samochod_id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-ok'></span></a>";
        echo "</td>";
        echo "</tr>";
}
